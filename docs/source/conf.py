# -*- coding: utf-8 -*-
#
# pynamodb_session_manager documentation build configuration file, created by
...
import pynamodb_session_manager as package
...
# Add data for Jinja2
try:
    from pynamodb_session_manager.docs import doc_data
except:
    doc_data = dict()
